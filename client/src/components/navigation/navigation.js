...
class Navigation extends Component{
    w3_open() {
        this.mainContent.current.style.marginLeft = this.props.windowWidth > 800 ? "20%" : "65%";
        this.mainContent.current.classList.add("w3-animate-left");
        this.mainContent.current.classList.remove("w3-animate-right");
        this.mySidebar.current.style.width = this.props.windowWidth > 800 ? "20%" : "65%";
    ...
    componentDidMount(){
        this.setState({
            navItems:[
                ...
                {'name': 'A History Of Layman Hours-All Post', 'route' : '/'}, 
                        ...
                        <div>
                            <div>
                                ...
                                >
                                    ...
                                    style={{ 'position': 'absolute', 'top': '0', 'left': '50px'}}>&#9776;</button>
